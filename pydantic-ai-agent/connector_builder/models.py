...
class ConnectorBuilderRunContext(BaseModel):
    ...
    custom_connector: Optional[Dict[str, Any]] = Field(default=None, description="The loaded custom connector data")
...
class ResponseFromConnectorBuilderAgent(BaseModel):
    ...
    function_type: Optional[str] = Field(default=None, description="The type of function generated (e.g., 'listTables')")
