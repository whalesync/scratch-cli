...
def create_connector_builder_agent(
    ...
    try:
        ...
        print(
            f"✅ Connector builder agent created successfully with model: {model_name}"
        )
        print(
            f"🔧 Agent has tools: execute_list_tables_tool, save_custom_connector_tool, save_custom_connector_with_test_result_tool"
        )
        return agent
