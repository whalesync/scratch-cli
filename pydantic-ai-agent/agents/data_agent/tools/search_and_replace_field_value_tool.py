...
def search_and_replace_field_value_tool_implementation(ctx: RunContext[ChatRunContext], table: TableSpec, wsId: str, column: ColumnSpec, search_value: str, new_value: str) -> str:
...
def define_search_and_replace_field_value_tool(agent: Agent[ChatRunContext, ResponseFromAgent], data_scope: Optional[str] = None):
    ...
    if data_scope == 'column':
        ...
        async def search_and_replace_value_tool(ctx: RunContext[ChatRunContext], search_value: str, new_value: str) -> str:  # type: ignore
            ...
            return search_and_replace_field_value_tool_implementation(ctx, table, wsId, column, search_value, new_value)
