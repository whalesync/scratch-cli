...
async def test_connector_builder():
    ...
    # Test parameters
    custom_connector_id = "test-connector-id"  # You'll need to replace this with a real ID
    message = "Generate a listTables function for a REST API that lists available tables"
