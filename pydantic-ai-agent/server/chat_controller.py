...
async def send_message(session_id: str, request: SendMessageRequestDTO):
    ...
    try:
        ...
        agent_response = await chat_service.process_message_with_agent(session, request.message, request.api_token, request.style_guides, request.model, request.view_id)
