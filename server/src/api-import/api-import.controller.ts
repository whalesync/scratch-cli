...
import { GenerateFetchRequest, GenerateFetchResponse, RestApiImportService } from './api-import.service';
...
export class RestApiImportController {
  ...
  @Post('/generate-fetch')
  async generateFetch(@Body() data: GenerateFetchRequest): Promise<GenerateFetchResponse> {
