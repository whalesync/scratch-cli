...
export const snapshotApi = {
  ...
  async publish(id: string): Promise<void> {
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${id}/publish`, {
      method: 'POST',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
      },
  ...
  async getPublishSummary(id: string): Promise<PublishSummary> {
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${id}/publish-summary`, {
      method: 'GET',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
      },
  ...
  async getRecord(snapshotId: string, tableId: string, recordId: string): Promise<SnapshotRecord> {
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${snapshotId}/tables/${tableId}/records/${recordId}`, {
      method: 'GET',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
      },
  ...
  async setActiveRecordsFilter(snapshotId: string, tableId: string, sqlWhereClause?: string): Promise<void> {
    const res = await fetch(
  ...
  async clearActiveRecordFilter(snapshotId: string, tableId: string): Promise<void> {
    const res = await fetch(
  ...
  async acceptCellValues(
    ...
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${snapshotId}/tables/${tableId}/accept-cell-values`, {
      method: 'POST',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
        'Content-Type': 'application/json',
  ...
  async rejectCellValues(
    ...
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${snapshotId}/tables/${tableId}/reject-values`, {
      method: 'POST',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
        'Content-Type': 'application/json',
  ...
  async importSuggestions(
    ...
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${snapshotId}/tables/${tableId}/import-suggestions`, {
      method: 'POST',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
      },
  ...
  async deepFetchRecords(
    ...
    const res = await fetch(`${API_CONFIG.getApiUrl()}/snapshot/${snapshotId}/tables/${tableId}/records/deep-fetch`, {
      method: 'POST',
      headers: {
        ...API_CONFIG.getAuthHeaders(),
        'Content-Type': 'application/json',
