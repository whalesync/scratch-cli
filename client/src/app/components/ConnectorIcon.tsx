...
export function ConnectorIcon(props: { connector: string | null } & Omit<ImageProps, 'src' | 'alt'>) {
  let iconUrl = props.connector ? connectorIconMap[props.connector?.toUpperCase() || ''] : '';
  if (!iconUrl) {
    iconUrl = connectorIconMap['CUSTOM'];
  }
...
export const connectorIconMap: Record<string, string> = {
  ...
  YOUTUBE: '/connector-icons/youtube-color-svgrepo-com.svg',
  CSV: '/connector-icons/csv-svgrepo-com.svg',
  CUSTOM: '/connector-icons/gear-svgrepo-com.svg',
};
