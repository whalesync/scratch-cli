...
import { ConnectorAIPromptProvider } from './ConnectorAIPromptContext';
...
export const ApiImport: FC = () => {
  ...
  const content = selectedConnectorId ? (
    <Box style={{ display: 'flex', height: 'calc(100vh - 120px)' }}>
                ...
                <Accordion.Item value="step3">
                  <Accordion.Control>
                    <Group gap="xs" align="center">
                      ...
                      <Tooltip label="Generate a function to fetch the schema (column structure) of a specific table. This helps understand the data structure.">
                        <Text size="sm" c="dimmed">
                          (What is fetch schema?)
                        </Text>
                      </Tooltip>
                    </Group>
                  </Accordion.Control>
                  <Accordion.Panel>
                    <Stack gap="sm">
                      <Group align="flex-start" gap="md">
                        <Stack style={{ flex: 1 }} gap="sm">
                          <Textarea
                            label="Fetch Schema Function"
                            placeholder="async function fetchSchema(apiKey, tableId) { ... }"
                          ...
                          <Button
                            ...
                            style={{ width: 'fit-content' }}
                          >
                            Generate Fetch Schema Function
                          </Button>
                        </Stack>
                        <Stack style={{ flex: 1 }} gap="sm">
                          <Textarea
                            ...
                            value={
                              schema
                                ...
                                : 'No schema yet. Click "Test Fetch Schema" to get started.'
                            }
                            styles={{
                              input: {
                                fontFamily: 'monospace',
                ...
                <Accordion.Item value="step4">
                  <Accordion.Control>
                    <Group gap="xs" align="center">
                      ...
                      <Tooltip label="Generate a function to fetch records from a specific table. This is the main function for getting your data.">
                        <Text size="sm" c="dimmed">
                          (What is poll records?)
                        </Text>
                      </Tooltip>
                    </Group>
                  </Accordion.Control>
                      ...
                      <Group align="flex-start" gap="md">
                        <Stack style={{ flex: 1 }} gap="sm">
                          <Textarea
                            ...
                            placeholder="async function pollRecords(apiKey, tableId) { ... }"
                          ...
                          <Textarea
                            ...
                            value={
                              response
                                ...
                                : 'No records yet. Click "Test Poll Records" to get started.'
                            }
                            styles={{
                              input: {
                                fontFamily: 'monospace',
                        ...
                        <Stack style={{ flex: 1 }} gap="sm">
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              setLoading(true);
                              try {
                                const result = await generateCreateRecord(aiPrompt, selectedConnectorId);
                        ...
                        <Stack style={{ flex: 1 }} gap="sm">
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              setLoading(true);
                              try {
                                const result = await generateUpdateRecord(aiPrompt, selectedConnectorId);
      ...
      <ConnectorAIPromptProvider>
        <ConnectorAIChatPanel isOpen={true} onClose={() => {}} snapshotId={selectedConnectorId || undefined} />
      </ConnectorAIPromptProvider>
    </Box>
  ) : (
    <Box>No connector selected</Box>
  );
  return (
